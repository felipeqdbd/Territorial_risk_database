...
All input paths are relative to `data/`. The notebook uses a fixed seed of **951** and writes sensitivity figures to `figures/`. It does not export sensitivity-analysis CSV files.
